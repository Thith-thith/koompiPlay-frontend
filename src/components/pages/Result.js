        ...
        if (state !== undefined){
            stats = (
                <React.Fragment>
                    ...
                    <form className="bg-indigo-200 container shadow-xl rounded px-8 pt-6 pb-8 mb-4 mx-auto mt-12 h-full">
                        ...
                        <section>
                           <Link to="/quiz"> <button className="w-32 mr-2 bg-blue-500 hover:bg-blue-400 text-white font-bold py-2 px-4 border-b-4 border-blue-700 hover:border-blue-500 rounded"> Play agian!</button></Link>
                            <Link to="/start"><button className="w-32 bg-blue-500 hover:bg-blue-400 text-white font-bold py-2 px-4 border-b-4 border-blue-700 hover:border-blue-500 rounded"> Submit </button></Link>
                        </section>
                    </form>
                </React.Fragment>
            )
